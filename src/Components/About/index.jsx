...
sistemas. Transformo requisitos complexos em aplicações web robustas usando 
        ...
        <div className="flex flex-wrap gap-4 pt-4">
          <a href="https://www.linkedin.com/in/adriano-souza-fonseca-868976300" target="_blank" rel="noreferrer" className="px-6 py-3 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/40 flex items-center gap-2">
            <Icons.LinkedIn /> Baixar Currículo
          </a>
          <a href="mailto:adrianoads910@gmail.com" className="px-6 py-3 bg-indigo-600 text-white font-medium rounded-lg hover:bg-indigo-700 transition shadow-lg shadow-indigo-500/20 hover:shadow-indigo-500/40 flex items-center gap-2">
            <Icons.Mail /> Contato
          </a>
